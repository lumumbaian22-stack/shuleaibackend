...
function allowedPermissions(user){const custom=user?.financePermissions||user?.preferences?.finance?.permissions;return Array.isArray(custom)&&custom.length?[...new Set(custom)]:defaultsFor(user);}
