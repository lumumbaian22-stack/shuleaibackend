...
const helpArticles = {
  ...
  parent: [
    ...
    { id: 2, title: 'Payments and balances', content: 'Use Payments inside Finance/Fees views to check balances and payment history. School fees should be paid to the school account, while platform subscriptions are separate.', keywords: ['payments','fees','balance','mpesa'], steps: ['Open Payments','Select child','Review balance','Pay using approved school method'] },
