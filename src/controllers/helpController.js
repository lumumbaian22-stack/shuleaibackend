...
const helpArticles = {
  ...
  parent: [
    ...
    { id: 4, title: 'Child AI tutor subscription', content: 'The AI Tutor has no free tier. Each child needs an active Basic, Premium or Ultimate subscription. Parents manage payment and renewal, while usage belongs to the selected child only.', keywords: ['ai','tutor','subscription','essential','smart','genius'], steps: ['Open Payments or Subscriptions','Select child','Activate Basic, Premium or Ultimate','Student uses AI Tutor from their own account'] }
  ],
  student: [
    { id: 1, title: 'Using the AI Tutor', content: 'Ask clear questions by subject and topic. AI Tutor access starts from an active Basic, Premium or Ultimate child subscription. There is no free tier, and only successful AI answers count against your limit.', keywords: ['ai','tutor','quiz','revise','homework','essential','smart','genius'], steps: ['Open AI Tutor','Type your question','Ask for examples or practice','Review usage remaining'] },
