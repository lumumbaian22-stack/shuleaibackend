...
module.exports = (sequelize, DataTypes) => {
  ...
  User.prototype.getPublicProfile = function() {
    return {
      ...
      signature: this.preferences?.signatureUrl || this.preferences?.signatureAbsoluteUrl || null,
      signatureUrl: this.preferences?.signatureUrl || this.preferences?.signatureAbsoluteUrl || null,
